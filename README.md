# 1. Overview
This repository provides an X-ray interstellar extinction model 
(Yan et al. 2026, ApJ, xxx, xxx; DOI: xxxxxxxx).

The model describes energy-dependent X-ray extinction in the ISM, 
including gas absorption, dust absorption, and dust scattering, 
based on updated dust physics, modified WD01 grain size distribution, 
and Proto-Solar + GCE abundances. 
It is implemented as an XSPEC multiplicative table model.
